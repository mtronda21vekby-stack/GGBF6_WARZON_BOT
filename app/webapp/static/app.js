...
(() => {
  ...
  window.__BCO_APP_BOOT_PROMISE__ = loadScript("/webapp/bco.i18n.js","__BCO_I18N_V38_LOADED__")
    ...
    .then(()=>loadScript("/webapp/bco.ecosystem-parity.js","__BCO_ECOSYSTEM_PARITY_V49_LOADED__").catch((error)=>{window.__BCO_ECOSYSTEM_PARITY_V49_LOADED__=false;console.warn("[BCO v49] Telegram parity controls unavailable",error);return false;}))
