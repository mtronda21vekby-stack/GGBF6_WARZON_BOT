...
(() => {
  ...
  // =========================================================
  // ✅ NEW ZOMBIES ENGINE BRIDGE (we are already on new engine)
  // =========================================================
  ...
  function zombiesStart() {
    const z = ZB();
    if (!z) return;
    try { z.start?.(state.mode?.toLowerCase?.() ? undefined : undefined); } catch {}
    try { z.start?.({ map: state.zombies_map }); } catch {}
    try { z.start?.(); } catch {}
  }
  ...
  function wireButtons() {
    ...
    // =========================================================
    // ✅ ZOMBIES (NEW ENGINE) — wire to BCO_ZOMBIES
    // =========================================================
