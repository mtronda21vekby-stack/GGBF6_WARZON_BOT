...
class Settings(BaseSettings):
    ...
    canonical_read_capability_enabled: bool = _env_on("CANONICAL_READ_CAPABILITY_ENABLED")
    canonical_read_flag_cache_ttl_s: float = float(os.getenv("CANONICAL_READ_FLAG_CACHE_TTL_S", "15"))
