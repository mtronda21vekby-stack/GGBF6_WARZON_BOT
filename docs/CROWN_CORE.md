...
- `CrownSkillRegistry` is an allow-list. The initial native surface exposes only read-only conversation, Player Brain and game-intelligence capabilities;
