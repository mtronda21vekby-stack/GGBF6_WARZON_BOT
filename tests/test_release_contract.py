...
def test_release_contract_is_explicit_and_readiness_exposes_natural_voice(monkeypatch):
    ...
    assert APP_VERSION == "41.0.0"
    assert RELEASE_CONTRACT == "bco-site-identity-assertion-v41"
    ...
    assert snap["release"]=={"version":"41.0.0","contract":"bco-site-identity-assertion-v41"}
