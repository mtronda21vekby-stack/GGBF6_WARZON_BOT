...
def test_release_contract_is_explicit_and_readiness_exposes_natural_voice(monkeypatch):
    ...
    assert APP_VERSION == "41.1.0"
    assert RELEASE_CONTRACT == "bco-lightweight-site-session-verify-v41.1"
    ...
    assert snap["release"]=={"version":"41.1.0","contract":"bco-lightweight-site-session-verify-v41.1"}
